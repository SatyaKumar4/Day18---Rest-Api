...
function showDetails(arr) {
    ...
    card.style.boxShadow="2px 2px 5px 5px rgba(0,0,0,0.15)";
    card.style.backgroundImage="linear-gradient(to right top, #ffffff, #ffecff, #ffd6d9, #ffd28e, #e9e351)";
    card.classList.add("mx-auto","card","rounded-3","align-items-center","justify-content-center","col-lg-8","col-sm-12","col-md-6");
    ...
    flag.style.boxShadow="2px 2px 5px 5px rgba(0,0,0,0.15)";
    ...
    weather.type="para";
    weather.style.boxShadow="2px 2px 5px 5px rgba(0,0,0,0.15)";
...
function getweather(lats,longs,index){
    ...
    .then((data1)=>{
        ...
        btn.innerHTML = `<ul style="list-style-type:none">
        <li>Temperature: ${data1.main.temp} °C</li>
        <li>Humidity: ${data1.main.humidity} %</li>
        </ul>
        `;
